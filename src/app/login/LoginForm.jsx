  ...
  return (
    <div className="w-full max-w-[480px] animate-fade-in-up relative z-20">
      ...
      <div className="backdrop-blur-xl bg-black/30 border border-white/10 rounded-[2rem] p-8 sm:p-10 shadow-2xl relative overflow-hidden">
        ...
        {/* Divider */}
        <div className="relative flex items-center justify-center my-8 animate-fade-in-up" style={{ animationDelay: "500ms", animationFillMode: "both" }}>
        ...
        {/* Social Logins */}
        <div className="grid grid-cols-2 gap-4 animate-fade-in-up" style={{ animationDelay: "600ms", animationFillMode: "both" }}>
          <button
            type="button"
