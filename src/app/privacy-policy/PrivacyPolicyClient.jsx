        ...
        <div className="max-w-3xl space-y-20 mx-auto">
          ...
          >
            ...
            <div className="text-[#6d513e] leading-relaxed space-y-6 text-base">
              <p>
                <span className="float-left text-6xl font-serif font-bold text-[#fc0a7a] mr-3 mt-1 leading-none">W</span>
              ...
              <p>
                ...
                <a href="mailto:support@wedhub.lk" className="text-[#fc0a7a] font-bold underline decoration-[#d4a853] underline-offset-4 hover:opacity-80 transition-opacity">
                  support@wedhub.lk
                </a>.
              </p>
              <p>
